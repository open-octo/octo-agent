...
export interface EndpointUpdateInput {
  new_id?: string
  // name: omit to keep the current display name, send '' to clear it.
  name?: string
  provider?: string
  base_url?: string
  api_key?: string
...
// rendered whenever the server runs on those platforms (SettingsModal
// experimental tab, desktop shell and web alike).
