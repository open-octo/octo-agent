<script lang="ts">
  ...
  import { ARTIFACT_SANDBOX, hydrateArtifact, lightAppSource, pathIsInside, selfContainedDocument } from '../lib/artifacts'
  ...
  // scripts for would come alive the moment it is saved.
  const laCurHTML = $derived(selfContainedDocument($lightappHTML[laCurSlug] ?? ''))
