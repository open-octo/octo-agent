...
- **Always-apply rules** — restated at the start and again at least every 10 turns, so they stay close to what you're doing, for something that must never be missed.
