...
0. **Environment names it?** A session running inside the server (Web UI,
   desktop, IM) has an `Octo server:` line in its Environment section. Use that
   address in place of `127.0.0.1:8088` in every command in this skill and skip
