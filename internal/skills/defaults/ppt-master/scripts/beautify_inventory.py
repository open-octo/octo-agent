...
Usage:
    uv run scripts/beautify_inventory.py <slide_library.json> [--images <image_manifest.json>] [-o inventory.json]

Examples:
    uv run scripts/beautify_inventory.py projects/x/analysis/<stem>.slide_library.json \
