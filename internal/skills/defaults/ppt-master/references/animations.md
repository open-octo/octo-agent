...
uv run skills/ppt-master/scripts/svg_to_pptx.py <project> -a auto
...
uv run skills/ppt-master/scripts/svg_to_pptx.py <project> -a auto --animation-trigger on-click
