...
# dependencies = ["Pillow>=9.0.0", "numpy>=1.20.0"]
# ///
"""
...
Examples:
    uv run scripts/gemini_watermark_remover.py projects/demo/images/bg_01.png
    uv run scripts/gemini_watermark_remover.py image.jpg -o image_clean.jpg
