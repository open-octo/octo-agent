...
| Memory backends | done | Optional self-hosted external semantic recall (hindsight / mem0 / agentmemory) — automatic background storage, `memory_recall` tool. Separate from and off by default; doesn't touch `MEMORY.md` |
