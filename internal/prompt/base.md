...
- **Drop stock AI phrasing, in any language.** Filler like "delve", "leverage", "it's worth noting", "Bottom line:", 值得注意的是, 总而言之, 赋能, 不是……而是……, or a question answered by its own "Answer:" / 答案是： says nothing. Don't coin compound labels for ordinary things ("exact-head checks", 打通闭环, 抓手); state the actual relationship with plain verbs.
