...
var Registry = []Vendor{
	...
	},
	{
		...
		Models:         []string{"deepseek-v4-flash", "deepseek-v4", "deepseek-v4-pro"},
	...
	},
	{
		...
		Models:         []string{"MiniMax-M2.5", "MiniMax-M2.7", "MiniMax-M3", "MiniMax-V1", "MiniMax-Speech-01"},
	...
	},
	{
		...
		Models:         []string{"kimi-k2.5", "kimi-k2.6", "kimi-k2.7", "kimi-math-8b"},
	...
	},
	{
		...
		Models:         []string{"kimi-for-coding", "kimi-k2.6", "kimi-k2.7"},
		APIKeyEnvVar:   "MOONSHOT_API_KEY",
		WebsiteURL:     "https://platform.moonshot.cn/console/api-keys",
	},
	{
		...
		Models:         []string{"glm-4.5", "glm-4.5-air", "glm-4.5-flash", "glm-4-air", "glm-4-flash"},
	...
	},
	{
		...
		Models:         []string{"qwen3.7-max", "qwen3.7-flash", "qwen3.5-plus", "qwen3.5-flash", "qwen3-max", "qwen-plus", "qwen-turbo"},
	...
	},
	{
		...
		Models:         []string{"mistral-small-latest", "mistral-medium-latest", "mistral-large-latest", "pixtral-large-latest"},
