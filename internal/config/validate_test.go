...
func TestConfigValidate_GlobalScalars(t *testing.T) {
	tests := []struct {
		...
		{"valid computer enabled on", Config{Tools: ToolsConfig{Computer: ComputerConfig{Enabled: "on"}}}, ""},
		{"valid computer enabled off", Config{Tools: ToolsConfig{Computer: ComputerConfig{Enabled: "off"}}}, ""},
		{"bad computer enabled", Config{Tools: ToolsConfig{Computer: ComputerConfig{Enabled: "yes"}}}, "tools.computer.enabled"},
